...
func buildDefaultPoolComponents(rdb redis.UniversalClient, logger *zap.Logger, queue string, opts *WorkerPoolOptions) {
	if !opts.cron.disabled && opts.cron.manager == nil && opts.cron.factory != nil {
	...
	if !opts.scheduler.disabled && opts.scheduler.scheduler == nil && opts.scheduler.factory != nil {
	...
	if !opts.janitor.disabled && opts.janitor.janitor == nil {
	...
	if !opts.disableRetention && opts.retentionJanitor == nil && opts.lifecycle != nil {
